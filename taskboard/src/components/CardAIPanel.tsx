      ...
      <div className="ai-messages" ref={listRef}>
        {messages.length === 0 && (
          <p className="sub ai-empty">
            Опишите, что нужно сделать по этой карточке — план, письмо, разбивку на шаги. Ответ можно одним кликом
            превратить в чек-лист, прикрепить как файл или сделать описанием карточки.
          </p>
        )}
        {messages.map((m) => (
